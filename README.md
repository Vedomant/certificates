...
| -------- | -------- | -------- |  -------- |  -------- |
| [Deep Learning School (МФТИ)](https://dls.samcs.ru/) | Deep Learning (семестр 1, весна 2025) | [сертификат на сайте Талант](https://talent.kruzhok.org/user/696585) |  июнь 2025 | Алгоритмы машинного обучения, полносвязные и сверточные нейронные сети для CV, CNN, cемантическая сегментация, GANs |
